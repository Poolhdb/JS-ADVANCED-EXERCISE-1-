...
const btn5 = document.getElementById("btn5"); // Ensure btn5 is referenced
const sortOrder = document.getElementById("sortOrder"); // Ensure sortOrder is referenced
...
btn4.addEventListener("click", () => {
    ...
    tbl.appendChild(resultDiv);
});

btn5.addEventListener("click", () => {
    if (numbersArr.length === 0) {
        alert("No numbers to evaluate.");
        return;
    }
